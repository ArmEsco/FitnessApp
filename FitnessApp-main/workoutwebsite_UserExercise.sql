...
CREATE TABLE `UserExercise` (
  ...
  CONSTRAINT `UserExercise_ibfk_1` FOREIGN KEY (`WorkoutID`) REFERENCES `WorkoutSession` (`WorkoutID`),
  CONSTRAINT `UserExercise_ibfk_2` FOREIGN KEY (`ExerciseID`) REFERENCES `Exercises` (`ExerciseID`)
...
-- Dump completed on 2024-12-16  9:13:47
